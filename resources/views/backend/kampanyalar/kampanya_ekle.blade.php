                    ...
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab2" role="tablist">
                            <button class="nav-link active fw600 ms-3" id="nav-item1-tab" data-bs-toggle="tab"
                                ...
                                aria-selected="true">Kampanya Ekle</button>
                        </div>
                    </nav>
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-item1" role="tabpanel"
                            ...
                            <div class="ps-widget bgc-white bdrs12 p30 overflow-hidden position-relative">
                                <form class="form-style1" action="{{ route('admin.kampanyalar.ekle.action') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="mb20">
                                                <label class="heading-color ff-heading fw600 mb10">Kampanya Başlığı</label>
                                                <input type="text" name="kampanya_baslik" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb20">
                                                ...
                                                <textarea id="kampanyaekle" name="kampanya_aciklama"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="upload-img position-relative overflow-hidden bdrs12 text-center mb30 px-2">
                                                ...
                                                <p class="text mb25">
                                                    Görsel, PNG, JPEG, JPG veya WEBP Formatında ve 1170x650 Boyutlarında Olmalıdır.
                                                </p>
