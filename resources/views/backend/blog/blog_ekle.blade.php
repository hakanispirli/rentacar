                    ...
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab2" role="tablist">
                            <button class="nav-link active fw600 ms-3" id="nav-item1-tab" data-bs-toggle="tab"
                                ...
                                aria-selected="true">Blog Yazısı Ekle</button>
                        </div>
                    </nav>
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-item1" role="tabpanel"
                            ...
                            <div class="ps-widget bgc-white bdrs12 p30 overflow-hidden position-relative">
                                <form class="form-style1" action="{{ route('admin.blog.ekle.action') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="mb20">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb20">
                                                ...
                                                <textarea id="blogEkle" name="blog_aciklama"></textarea>
                                            </div>
                                        </div>
