                    ...
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab2" role="tablist">
                            <button class="nav-link active fw600 ms-3" id="nav-item1-tab" data-bs-toggle="tab"
                                ...
                                aria-selected="true">S.S.S. Ekle</button>
                        </div>
                    </nav>
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-item1" role="tabpanel"
                            ...
                            <div class="ps-widget bgc-white bdrs12 p30 overflow-hidden position-relative">
                                <form class="form-style1" action="{{ route('admin.faq.ekle.action') }}" method="post">
                                    @csrf
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="mb20">
                                                <label class="heading-color ff-heading fw600 mb10">SSS Başlığı</label>
                                                <input type="text" name="faq_baslik" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="mb20">
                                                <label class="heading-color ff-heading fw600 mb10">SSS Açıklama</label>
                                                <textarea type="text" name="faq_aciklama" class="form-control" rows="10" style="height: 200px;"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
