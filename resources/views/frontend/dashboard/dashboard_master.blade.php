...
<head>
    ...
    <title>Asrin Plus - Yönetici Paneli</title>
...
<body>
    <div class="wrapper">
        ...
        @include('frontend.dashboard.include.mobile_nav')
                ...
                <div class="dashboard__sidebar d-none d-lg-block">
                    <div class="dashboard_sidebar_list">
                        <div class="sidebar_list_item">
                            <a href="{{ route('dashboard') }}" class="items-center -is-active"><i
                                    class="flaticon-user mr15"></i>Hesabım</a>
                        </div>
                        <div class="sidebar_list_item">
                            <a href="#" class="items-center mt10"><i
                                    class="flaticon-discovery mr15"></i>Rezervasyonlarım</a>
                        </div>

                        <div class="sidebar_list_item">
                            <a href="#" class="items-center mt10"><i
                                    class="flaticon-protection mr15"></i>Faturalarım</a>
                        </div>

                        <div class="sidebar_list_item">
                            <a href="#" class="items-center mt10"><i
                                    class="flaticon-review mr15"></i>Değerlendirmeler</a>
                        </div>
