    ...
    <div class="hsidebar-content">
        <div class="hiddenbar_navbar_content">
            <div class="hiddenbar_navbar_menu">
                <ul class="navbar-nav">
                    <li class="nav-item"> <a class="nav-link" href="{{ route('kurumsal') }}" role="button">Kurumsal</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ route('araclar') }}" role="button">Araçlar</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ route('sss') }}" role="button">S.S.S.</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ route('iletisim') }}" role="button">İletişim</a></li>
                </ul>
            </div>
